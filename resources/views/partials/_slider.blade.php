...
<section id="slider" class="no-padding content-top-margin">
    <div id="owl-demo" class="owl-carousel owl-theme owl-half-slider dark-pagination">
        <div class="item owl-bg-img" style="background-image:url('images/slider/slider-img10.webp');">
        ...
        <div class="item owl-bg-img" style="background-image:url('images/slider/slider-img11.webp');">
            <div class="container position-relative">
                <div class="slider-typography text-left">
                    <div class="slider-text-middle-main">
        ...
        <div class="item owl-bg-img" style="background-image:url('images/slider/slider-img9.webp');">
            <div class="container position-relative">
                <div class="slider-typography text-left">
                    <div class="slider-text-middle-main">
                        <div class="slider-text-middle padding-left-right-px">
